...
.log 6 "Setting dock to left side of screen"
defaults write com.apple.Dock orientation left

# Enable autohide
.log 6 "Setting dock to autohide"
defaults write com.apple.Dock autohide 1

# Autohide delay effectively 0
.log 6 "Setting dock to no delay when showing"
defaults write com.apple.Dock autohide-delay -float 0.001

# Instant disappearing dock
.log 6 "Setting dock to no delay when hiding"
...
.log 6 "Setting dock to show application when scrolled"
defaults write com.apple.Dock scroll-to-open -bool TRUE

# Better animation than "Genie"
.log 6 "Setting dock to have hidden 'suck' effect"
defaults write com.apple.Dock mineffect suck

# Show "Hidden" applications transparent
.log 6 "Setting dock to show hidden applications as transparent"
defaults write com.apple.Dock showhidden -bool TRUE

.log 6 "Restarting dock to apply changes"
killall Dock